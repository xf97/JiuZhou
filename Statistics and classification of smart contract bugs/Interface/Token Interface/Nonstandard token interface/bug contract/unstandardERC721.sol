...
contract IERC721 is IERC165 {
    ...
    //1. The parameters of the event should be indexed
  event Transfer(
    address from,
    address indexed to,
  ...
  event ApprovalForAll(
    ...
    //2.The function does not return a value of the specified type as standard
...
contract ERC721 is ERC165, IERC721 {
   ...
   */
  function balanceOf(address owner) public view returns (uint8) {
    require(owner != address(0));
    return uint8(_ownedTokensCount[owner]);
  }
  ...
  function ownerOf(uint256 tokenId) public view returns (address) {
    ...
    return owner;
     ...
     /*
    4.No event is recorded in the specified function
    */
  /**
...
*/
  ...
  /*
    5.Raises an exception in a function that should return a Boolean value
    6.A function that returns a Boolean value should not return only one result
    */
  /**
